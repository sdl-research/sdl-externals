...
class EditFstData {
 public:
  ...
  typedef typename std::tr1::unordered_map<StateId, StateId>::const_iterator
      IdMapIterator;
  typedef typename std::tr1::unordered_map<StateId, Weight>::const_iterator
      FinalWeightIterator;
 ...
 private:
  ...
  // appear in edits_.
  std::tr1::unordered_map<StateId, StateId> external_to_internal_ids_;
  ...
  std::tr1::unordered_map<StateId, Weight> edited_final_weights_;
