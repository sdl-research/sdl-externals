...
PdtInfo<A>::PdtInfo(const Fst<A> &fst,
  ...
  std::tr1::unordered_map<Label, size_t> paren_map;
  std::tr1::unordered_set<Label> paren_set;
  std::tr1::unordered_set<StateId> open_paren_state_set;
  std::tr1::unordered_set<StateId> close_paren_state_set;
  ...
  for (StateIterator< Fst<A> > siter(fst);
    ...
    for (ArcIterator< Fst<A> > aiter(fst, s);
      ...
      ++narcs_;
      typename std::tr1::unordered_map<Label, size_t>::const_iterator pit
