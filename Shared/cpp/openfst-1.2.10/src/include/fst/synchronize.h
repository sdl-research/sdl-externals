...
class SynchronizeFstImpl
 ...
 private:
  ...
  typedef std::tr1::unordered_map<Element, StateId, ElementKey, ElementEqual> ElementMap;
  typedef std::tr1::unordered_set<const String*, StringKey, StringEqual> StringSet;
