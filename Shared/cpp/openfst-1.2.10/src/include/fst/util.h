...
READ_STL_ASSOC_TYPE(std::tr1::unordered_set);
READ_STL_ASSOC_TYPE(map);
READ_STL_ASSOC_TYPE(std::tr1::unordered_map);
...
WRITE_STL_ASSOC_TYPE(std::tr1::unordered_set);
WRITE_STL_ASSOC_TYPE(map);
WRITE_STL_ASSOC_TYPE(std::tr1::unordered_map);
